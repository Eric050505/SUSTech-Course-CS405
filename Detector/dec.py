...
class Detector:
    ...
    def loadClassifier(self, filepath=None, classifier_data=None):
        ...
        """
        Load a classifier trained by the functions in dataset.py. Either a dict
    ...
    def detectVideo(self, video_capture=None, num_frames=9, threshold=120,
                    ...
                    draw_heatmap_size=0.2, write=True, write_fps=24, filename=None):
